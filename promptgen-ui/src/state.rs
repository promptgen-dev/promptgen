...
pub struct AppState {
    ...
    pub slot_picker_sort_order: VariableSortOrder,
    pub option_sort_order: VariableSortOrder,
    pub slot_picker_option_sort_order: VariableSortOrder,
...
impl Default for AppState {
    fn default() -> Self {
        ...
        Self {
            ...
            slot_picker_sort_order: VariableSortOrder::default(),
            option_sort_order: VariableSortOrder::default(),
            slot_picker_option_sort_order: VariableSortOrder::default(),
